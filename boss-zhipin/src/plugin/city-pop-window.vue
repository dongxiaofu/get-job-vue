...
export default {
  ...
  data() {
    return {
      ...
      apiHost: '',
      getCityListByFirstLetterApi: '/api/city/list/first-letter',
    };
  },
  ...
  methods: {
    ...
    getCityList: function (cityCategoryStr) {
      let getCityListByFirstLetterApi = this.apiHost + this.getCityListByFirstLetterApi;
      console.log('getCityListByFirstLetterApi ================== start')
      console.log(getCityListByFirstLetterApi)
      console.log('getCityListByFirstLetterApi ================== end')
      this.$http.get((getCityListByFirstLetterApi), {params: {first_letter: cityCategoryStr}}).then(response => {
